...
import 'edit_old_model.dart';
export 'edit_old_model.dart';

class EditOldWidget extends StatefulWidget {
  const EditOldWidget({
    super.key,
  ...
  @override
  State<EditOldWidget> createState() => _EditOldWidgetState();
}

class _EditOldWidgetState extends State<EditOldWidget>
    with TickerProviderStateMixin {
  late EditOldModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditOldModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      setState(() {
        _model.linkXState = widget.notesPar!.linkX;
        _model.linkIdState = widget.notesPar?.linkId;
      });
    });
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<TreeRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<TreeRecord> editOldTreeRecordList = snapshot.data!;
