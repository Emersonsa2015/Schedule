    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      setState(() {
        FFAppState().SettingsPatch =
            'https://firebasestorage.googleapis.com/v0/b/schedule-da0ad.appspot.com/o/Settings.jpg?alt=media&token=8b6a963f-6e7d-4dca-a266-522203280497';
      });
      setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<NotesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<NotesRecord> homeCopyNotesRecordList = snapshot.data!;
